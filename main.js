...
// const testFileUrl = 'https://staging-falconfinet.azurewebsites.net/wp-content/uploads/2024/07/download-image.jpeg'; // URL of the test file
...
//    console.log(`Speed: ${result} Mbps`);
// }).catch(error => {
//    console.error('Error testing speed:', error);
// });

// console.log(81746935.81930286 / 1024);
